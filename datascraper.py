...
#
# Modified to extract NCAA College Basket Ball data from  https://www.sports-reference.com/cbb/
#
...
#
#  Function Added to get School GameLog URL
#
#  Gamelog url is https://www.sports-reference.com/cbb/schools/air-force/2022-gamelogs.html
#  School url is --> https://www.sports-reference.com/cbb/schools/air-force/2022.html
# 
...
def get_game_logs (game_log):
    ...
    for i, table in enumerate(tables, start=1):
        ...
        print ('school_headers --> ', school_headers)
        # print ('Rows --> ', rows[0])
