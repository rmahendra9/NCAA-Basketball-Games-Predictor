...
def main():
    ...
    while True:
        ...
        team_a_possessions = df.loc[team_a]['Adj T.']
        team_a_predicted_points = (team_a_predicted_adjoe * team_a_possessions) / 100
        # Repeat for team_b 
        ...
        team_b_possessions = df.loc[team_b]['Adj T.']
        team_b_predicted_points = (team_b_predicted_adjoe * team_b_possessions) / 100
